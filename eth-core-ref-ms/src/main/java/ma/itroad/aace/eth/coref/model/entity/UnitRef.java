...
@GenericGenerator(name = "eth_seq_generator",
        ...
        parameters = {@org.hibernate.annotations.Parameter(name = "sequence_name", value = "eth.unit_ref_seq")})
...
@Setter
@Entity
@Table(name = "unit_ref", schema = "eth")
public class UnitRef extends CodeEntity {

    private String name;

    @OneToMany(mappedBy = "unitRef")
