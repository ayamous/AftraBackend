...
@GenericGenerator(name = "eth_seq_generator",
        ...
        parameters = { @org.hibernate.annotations.Parameter(name = "sequence_name", value = "eth.agreement_type_seq") })
...
@Setter
@Entity
@Table(name = "agreement_type" , schema = "eth")
public class AgreementType extends CodeEntity {
    private String name;
